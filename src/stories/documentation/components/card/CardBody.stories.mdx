...
You can customize its appearance with various props, including [swatch colors](http://localhost:6006/?path=/docs/documentation-themes--docs#swatch-colors) through the `swatch` prop.
