...
You can customize the bullet with a custom character, although you may need a [custom Font](https://justinmahar.github.io/react-pdf-builder/?path=/docs/documentation-fonts--docs#using-custom-fonts) that includes your desired symbol.
