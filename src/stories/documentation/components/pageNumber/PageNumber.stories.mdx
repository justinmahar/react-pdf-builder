...
| ------ | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| format | `string`      | Optional. Customize how the page number string is displayed with a template string containing `%n` for the current page number, `%t` for the total number of pages, `%sn` for the sub page number, or `%st` for the sub pages total. Default format is `"%n / %t"`. |
