...
You can customize the look with [swatch colors](http://localhost:6006/?path=/docs/documentation-themes--docs#swatch-colors), styles, and [class names](https://justinmahar.github.io/react-pdf-builder/?path=/docs/documentation-themes--docs#class-names). In addition to the theme's [swatch colors](http://localhost:6006/?path=/docs/documentation-themes--docs#swatch-colors), a special swatch is available called `'link'` that will make the button appear as a link.
