...
You can choose between predefined colors via the `swatch` prop and a [swatch color](http://localhost:6006/?path=/docs/documentation-themes--docs#swatch-colors), or define custom gradients, specifying the direction and even using gradient stops for more control.
