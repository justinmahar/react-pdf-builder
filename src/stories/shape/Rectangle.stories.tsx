...
import { RectangleShape, RectangleShapeProps } from '../../components/shapes/RectangleShape';
import { GradientType } from '../../components/shapes/Gradients';

const StoryComponent = (props: RectangleShapeProps) => {
  return (
    <PDFStory>
...
const meta: Meta<typeof StoryComponent> = {
  title: 'Stories/Shape/Rectangle', // <-- Set to your story title
