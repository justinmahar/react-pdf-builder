...
import { SwatchColor } from '../../components/theme/ColorScheme';
...
const StoryComponent = ({ swatch, format }: StoryProps) => {
  return (
    <PDFStory pageProps={{ style: { paddingTop: 50, paddingLeft: 50, paddingRight: 50, paddingBottom: 110 } }}>
      ...
      <Heading4 rule>Lorem ipsum dolor sit amet</Heading4>
      <Paragraph>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
      ...
      <Heading4 rule>Cupidatat non proident</Heading4>
      <Paragraph>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
...
const meta: Meta<typeof StoryComponent> = {
  title: 'Stories/PageNumber', // <-- Set to your story title
