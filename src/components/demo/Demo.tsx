      ...
      <PDFViewer style={{ height: 700, width: 500 }}>
        <Document>
          <PDFThemeProvider theme={theme}>
            {showCoverPage && (
              <ThemedPage size={pageSize} orientation={orientation} className="flex-column text-white p-0">
                <GradientBackdrop
                  size={pageSize}
            ...
            <ThemedPage size={pageSize} orientation={orientation}>
              <GradientBackdrop
                size={pageSize}
                orientation={orientation}
                gradient={[
              ...
              <Box dir="y" className="gap-2">
                ...
                <HorizontalRule />
                <Paragraph>
                  Above this paragraph is a horizontal rule. Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Below is a signature component.
                </Paragraph>
                ...
                <Paragraph>
                  Shape components are available for circles, ellipses, rectangles, and squares. These components make
                  SVG sizing, gradients, and strokes convenient for these four simple shapes so you can focus on
